...
# wheel
# path = '//192.168.199.148/Wheel/TrainSampleAuto/'
new_path = '//192.168.199.148/NEW_samples_largger/Rider/neg/cas2/neg'
i = 0
j = 0
        ...
        for f in files:
            ...
            if os.path.basename(fullpath) != 'Thumbs.db':
                ...
                try:
                    ...
                    if width >= 32:
                        dst = os.path.join(os.path.abspath(new_path), 'neg_rider_' + str(i) + '.png')
                        print(dst)
