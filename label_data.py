...
# 合并csv
csv_list = glob.glob(os.path.join('//DESKTOP-ASB277M/Data_3D/Training/labels', '*.csv'))  # 把同文件夹下的csv文件放在csv_list中
for i in csv_list:
...
# ----------------------------------------------------------------------------------------------------------------
#
# image_path = '//DESKTOP-ASB277M/Data_3D/Training/POS/cas44/'
...
#
# with open('cas44.csv', 'w', newline='') as f:
